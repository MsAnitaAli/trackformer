...
python src/track_summary.py with reid \
    ...
    output_dir=results/temporal_memory_eval_reid_TRAIN \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_full/checkpoint_epoch_50.pth \
    output_dir=results/temporal_memory_eval_Noreid_TRAIN \
...
python src/track_summary.py with reid \
    ...
    output_dir=results/temporal_memory_eval_reid_bestIDF1_TRAIN \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_full/checkpoint_best_IDF1.pth \
    output_dir=results/temporal_memory_eval_Noreid_bestIDF1_TRAIN \
...
python src/track_summary.py with reid \
    ...
    output_dir=results/temporal_memory_eval_reid_bestMOTA_TRAIN \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_full/checkpoint_best_MOTA.pth \
    output_dir=results/temporal_memory_eval_Noreid_bestMOTA_TRAIN \
