...
python src/track_summary.py with reid \
    ...
    output_dir=results/scale_aware_eval_reid_TRAIN \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_scale_aware/checkpoint_epoch_10.pth \
    output_dir=results/scale_aware_eval_Noreid_TRAIN \
...
python src/track_summary.py with reid \
    ...
    output_dir=results/scale_aware_eval_reid_bestIDF1_TRAIN \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_scale_aware/checkpoint_best_IDF1.pth \
    output_dir=results/scale_aware_eval_Noreid_bestIDF1_TRAIN \
...
python src/track_summary.py with reid \
    ...
    output_dir=results/scale_aware_eval_reid_bestMOTA_TRAIN \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_scale_aware/checkpoint_best_MOTA.pth \
    output_dir=results/scale_aware_eval_Noreid_bestMOTA_TRAIN \
