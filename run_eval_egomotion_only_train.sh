...
python src/track_summary.py with reid \
    ...
    obj_detect_checkpoint_file=models/egohumans_egomotion_only/checkpoint_best_IDF1.pth \
    output_dir=results/egomotion_only_eval_reid_bestIDF1_TRAIN \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_egomotion_only/checkpoint_best_IDF1.pth \
    output_dir=results/egomotion_only_eval_Noreid_bestIDF1_TRAIN \
    write_images=False || echo "Command 2 failed, continuing..."

#ver 3. Best MOTA — with reid
python src/track_summary.py with reid \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_egomotion_only/checkpoint_best_MOTA.pth \
    output_dir=results/egomotion_only_eval_reid_bestMOTA_TRAIN \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_egomotion_only/checkpoint_best_MOTA.pth \
    output_dir=results/egomotion_only_eval_Noreid_bestMOTA_TRAIN \
    write_images=False || echo "Command 4 failed, continuing..."

#ver 5. Epoch 10 — with reid
python src/track_summary.py with reid \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_egomotion_only/checkpoint_epoch_10.pth \
    output_dir=results/egomotion_only_eval_reid_TRAIN \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_egomotion_only/checkpoint_epoch_10.pth \
    output_dir=results/egomotion_only_eval_Noreid_TRAIN \
