...
class EgohumansSequence(MOT17Sequence):
    data_folder = 'Egohumans_MOT' # <--- NEW: Custom folder name
    ...
    def __init__(self, root_dir: str = 'data', seq_name: str = None,
        ...
        # <--- MODIFIED: Uses self.data_folder ('Egohumans_MOT') instead of 'MOT17'
...
"""
old script that ran successfully on TRAIN and TEST goes here
"""
#import os
#import os.path as osp
#import csv
...
#class EgohumansSequence(MOT17Sequence):
#    """
#    Specialized loader for Egohumans that supports the 'val' split 
#    and flexible integer parsing for floating-point strings.
#    """
#    data_folder = 'Egohumans_MOT'
