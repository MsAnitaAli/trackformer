# OLD Verbose code goes here______________________________
...
def build_dataset(split: str, args: Namespace) -> Dataset:
    ...
    # Add this elif block for egohumans
    elif args.dataset == 'egohumans':
        dataset = build_coco(split, args)
    # Add this elif block for egohumans_full
    elif args.dataset == 'egohumans_full':
        dataset = build_coco(split, args)
