...
def generate_coco_from_egohuman(data_root, split_name):
    ...
    annotation_file = os.path.join(annotations_dir, f'{split_name}_coco.json')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Generate COCO from EgoHumans (Full) MOT.')
    parser.add_argument('--data_root', type=str, default='data/Egohumans_full_MOT')
