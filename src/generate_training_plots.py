"""
This code reads training log file and generates these 2 graphs as pdf and esp. standard format for Q1 journals
...
my_model_name can be replaced with my model name, if other than egohumans_appearance. as, it is set as default is in code
"""
import os
import re
import sys
