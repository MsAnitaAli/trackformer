...
python src/track_summary.py with \
    ...
    output_dir=results/egohumans_full_evaluation_reid_best_IDF1 \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-ALL \
    obj_detect_checkpoint_file=models/egohumans_full/checkpoint_best_IDF1.pth \
    output_dir=results/egohumans_full_evaluation_noreid_best_IDF1 \
...
python src/track_summary.py with \
    ...
    output_dir=results/egohumans_full_evaluation_reid_best_MOTA \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-ALL \
    obj_detect_checkpoint_file=models/egohumans_full/checkpoint_best_MOTA.pth \
    output_dir=results/egohumans_full_evaluation_noreid_best_MOTA \
...
python src/track_summary.py with \
    ...
    output_dir=results/egohumans_full_evaluation_reid \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-ALL \
    obj_detect_checkpoint_file=models/egohumans_full/checkpoint_epoch_50.pth \
    output_dir=results/egohumans_full_evaluation_noreid \
