...
python src/track_summary.py with reid \
    ...
    output_dir=results/egomotion_only_eval_reid_bestIDF1_TEST \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TEST \
    obj_detect_checkpoint_file=models/egohumans_egomotion_only/checkpoint_best_IDF1.pth \
    output_dir=results/egomotion_only_eval_Noreid_bestIDF1_TEST \
...
python src/track_summary.py with reid \
    ...
    output_dir=results/egomotion_only_eval_reid_bestMOTA_TEST \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TEST \
    obj_detect_checkpoint_file=models/egohumans_egomotion_only/checkpoint_best_MOTA.pth \
    output_dir=results/egomotion_only_eval_Noreid_bestMOTA_TEST \
...
python src/track_summary.py with reid \
    ...
    output_dir=results/egomotion_only_eval_reid_TEST \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TEST \
    obj_detect_checkpoint_file=models/egohumans_egomotion_only/checkpoint_epoch_10.pth \
    output_dir=results/egomotion_only_eval_Noreid_TEST \
