...
#    output_dir=results/appearance2_eval_reid_bestIDF1_TRAIN \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_appearance2/checkpoint_best_IDF1.pth \
    output_dir=results/appearance2_eval_Noreid_bestIDF1_TRAIN \
...
python src/track_summary.py with \
    ...
    output_dir=results/appearance2_eval_reid_bestMOTA_TRAIN \
...
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_appearance2/checkpoint_best_MOTA.pth \
    output_dir=results/appearance2_eval_Noreid_bestMOTA_TRAIN \
    write_images=False || echo "Command 4 failed, continuing..."

#ver 5. Best checkpoint with reid 15th is the best, though code was run till 20
python src/track_summary.py with \
    reid \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_appearance2/checkpoint_epoch_15.pth \
    output_dir=results/appearance2_eval_reid_TRAIN \
    write_images=False || echo "Command 5 failed, continuing..."

#ver 6. Best checkpoint with no reid 15th is the best, though code was run till 20 
python src/track_summary.py with \
    dataset_name=Egohumans_full-TRAIN \
    obj_detect_checkpoint_file=models/egohumans_appearance2/checkpoint_epoch_15.pth \
    output_dir=results/appearance2_eval_Noreid_TRAIN \
